    ...
    _createClass(e, [{
      ...
      value: function getElementListener() {
        ...
        if ("string" == typeof this.settings["mouse-event-element"]) {
          var _e = document.querySelector(this.settings["mouse-event-element"]);
      ...
      value: function onDeviceOrientation(e) {
        ...
        var t = this.settings.gyroscopeMaxAngleX - this.settings.gyroscopeMinAngleX,
            ...
            s = t / this.width,
            n = i / this.height,
            l = (e.gamma - (this.settings.gyroscopeMinAngleX + this.gammazero)) / s,
            a = (e.beta - (this.settings.gyroscopeMinAngleY + this.betazero)) / n;
      ...
      value: function prepareGlare() {
        if (!this.glarePrerender) {
          ...
          _e2.classList.add("js-tilt-glare");

          var t = document.createElement("div");
          t.classList.add("js-tilt-glare-inner"), _e2.appendChild(t), this.element.appendChild(_e2);
        }
      ...
      key: "extendSettings",
      value: function extendSettings(e) {
        var t = {
          reverse: !1,
          max: 15,
          startX: 0,
        ...
        for (var s in t) {
          if (s in e) i[s] = e[s];else if (this.element.hasAttribute("data-tilt-" + s)) {
            var _e3 = this.element.getAttribute("data-tilt-" + s);
      ...
      key: "isSettingTrue",
      value: function isSettingTrue(e) {
        return "" === e || !0 === e || 1 === e;
      }
    }, {
      key: "init",
